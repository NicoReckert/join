...
return`
    <div class="new-Contect-Container">
        ...
        <div class="add-input-contect-container">
            <div class="close-btn">
                <button onclick="addNewContectOverlay()"><img src="assets/icons/close.svg" alt=""></button>
            </div>
...
function getEditContactTemplate(key) {
    return`
        <div class="new-Contect-Container">
            ...
            <div class="add-input-contect-container">
                <div class="close-btn">
                    <button onclick="editContactOverlay('${key}')"><img src="assets/icons/close.svg" alt=""></button>
                </div>
                ...
                <form onsubmit="return editContact(event, this);">
                    <div class="input-container">
                        ...
                        <div class="contact-button-container">
                            <button class="cancel-btn" onclick="deleteContact('${key}'); ";>Delete</button>
